...
<?php 
    ...
    font-size: 19px;
    font-family: cabin;
    font-weight: 500;">T(n) = (n<sup>log<sub>2</sub>n</sup>+n)/2</div>
             <?php
                }?>
    ...
    margin-right: -48px;
    margin-top: 28px;">
                <a href="exo4.php"><img style="margin-right: 7px;width:32px" src="../img/previous.png"></a>
                <a href="exo6.php" ><img style="width:32px" src="../img/next.png"></a>
            </div>
            </form>
