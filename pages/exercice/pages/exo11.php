...
font-size: 14px;"><img src="img/admiine.png" style="width: 25px;
    ...
    padding-right: 100px;">
            ...
            Calculer T(n) d'algorithme suivant si en prise en compte tous les instructions constants ? </div>
    <br><br>
...
<?php 
    ...
    margin-right: -48px;
    margin-top: 28px;">
                <a class="btn btn-outline-primary" style="margin-right: 14px;
    border-radius: 3px;
    background: #c3a16f;
    color: white;"><--</A>
                <a name="ikhan" class="btn btn-primary" style="background: #907855;border: none;">--></a>
            </div>
            </form>
