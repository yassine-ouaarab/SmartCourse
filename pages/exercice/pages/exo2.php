...
font-size: 14px;"><img src="img/admiine.png" style="width: 25px;
    ...
    border-radius: 2px;
    background: #337ab7;
    color: white;" name= "reponse" >Reponse ...</button>
...
<?php 
    ...
    margin-right: -48px;
    margin-top: 28px;">
                <a href="exo1.php"><img style="margin-right: 7px;width:32px" src="../img/previous.png"></a>
                <a href="exo3.php" ><img style="width:32px" src="../img/next.png"></a>
            </div>
            </form>
