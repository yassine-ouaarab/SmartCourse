...
font-size: 14px;"><img src="img/admiine.png" style="width: 25px;
    ...
    <form method="POST" class="form-horizontal" enctype="multipart/form-data">
           ...
           Trouver theta de l'algoriyhme suivant en utilisant "Master Method"?
   ...
   font-size: 16px;
   font-weight: 600;">
            Fonction fact (i : entier) : entier <br>
            si (n=1)<br>
            retourne 1<br>
            Sinon<br>
            retourne fact(n/2)<br> 
            FinSi<br>
            FinFonction<br>

            avec T(n)=T(n/2)+1 </div>
...
<?php 
    ...
    font-size: 19px;
    font-family: cabin;
    font-weight: 500;">Theta(n<sup>2</sup>)</div>
             <?php
                }?>
    ...
    margin-right: -48px;
    margin-top: 28px;">
                <a href="exo5.php"><img style="margin-right: 7px;width:32px" src="../img/previous.png"></a>
                <a href="exo7.php" ><img style="width:32px" src="../img/next.png"></a>
            </div>
            </form>
