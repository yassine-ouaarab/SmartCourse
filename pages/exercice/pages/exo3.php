...
<br>
    ...
    font-size: 19px;
    font-family: cabin;
    font-weight: 500;">T(n) = log<sub>3</sub>n</div>
             <?php
                }?>
    ...
    margin-right: -48px;
    margin-top: 28px;">
                <a href="exo2.php"><img style="margin-right: 7px;width:32px" src="../img/previous.png"></a>
                <a href="exo4.php" ><img style="width:32px" src="../img/next.png"></a>
            </div>
            </form>
