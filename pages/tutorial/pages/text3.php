...
<!-- /.container -->
    ...
    padding: 9px;
    margin-bottom: -9px;
    text-align: center;">Chapitre III : Complexité Asymptotique</div>
            <div style="background: white">

                <hr>
                <img src="../../../DATABASE/22.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/23.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/24.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/25cp.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/26.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/27.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/28.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/29.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/30.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/31.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/32.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/33.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/34.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/35.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/36.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/37.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                </div>
            ...
            <div class="btn-group" role="group" aria-label="Basic example" style="float: right;margin-right: 0px;">
                <a class="btn btn-outline-primary" href ="text2.php" style="margin-right:15px;width: 100px;background: white;
    color: black;
    font-family: cabin;
    font-size: 15px;
    border: none;"><- Chapitre II</a>
                <a class="btn btn-primary" href="text4.php" style="background: white;
    color: black;
    font-family: cabin;
    font-size: 15px;
    border: none;">Chapitre VI -></a>
            </div> 
