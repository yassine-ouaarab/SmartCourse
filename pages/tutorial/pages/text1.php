...
<!-- /.container -->
    ...
    font-size: 26px;
    padding: 9px;
    text-align: center;">Chapitre I : Rappels sur l'Algorithmique</div>
                <div style="background: white">

                <img src="../../../DATABASE/1.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;padding-top:40px">
                <hr>
                <img src="../../../DATABASE/2.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/4.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/5.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/6.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/7cp.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/8cp.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/9.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/10cp.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/11.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/12cp.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                ...
                <a class="btn btn-outline-primary" href ="text2.php" style="background: white;
    color: black;
    font-family: cabin;
    font-size: 15px;
