...
<!-- /.container -->
    ...
    padding: 9px;
    margin-bottom: -9px;
    text-align: center;">Chapitre II : Introduction à la complexité Algorithmique</div>
                <div style="background: white">

                <hr>
                <img src="../../../DATABASE/13.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/14.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/15.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/16.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/17cp.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/18cp.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/19.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/20.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                <img src="../../../DATABASE/21.png" style="width: 670px;margin-left: 152px;padding: 0px 40px;">
                <hr>
                ...
                <a class="btn btn-outline-primary" href ="text1.php" style="margin-right:15px;width: 100px;background: white;
    color: black;
    font-family: cabin;
    font-size: 15px;
    border: none;"><- Chapitre I</a>
                <a class="btn btn-primary" href="text3.php" style="background: white;
    color: black;
    font-family: cabin;
    font-size: 15px;
