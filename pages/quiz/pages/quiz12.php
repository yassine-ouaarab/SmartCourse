...
font-size: 14px;"><img src="img/admiine.png" style="width: 25px;
    ...
    margin-top: 10px;">
        <div class="sidebar-nav navbar-collapse" style="background-color : #f3f3f3">
            ...
            <li>
                        ...
                        <li>
                            <a href="quiz12.php" class="active">
    ...
    <div id="page-wrapper" style="margin:0 0 0 320px">
           ...
           Trouver T(n) final pour l'equation suivant de ce algorithme ?<br>
            T(n) = 2T(n/2)+n
            en utilisant "Substitution Method"            </div>
   <br>
...
<br><br><br>
   ...
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">T(n)=log<sub>2</sub>n
</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">T(n)=nlog<sub>2</sub>n</button><br><br><br>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">T(n)=n+nlog<sub>2</sub></button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;" >T(n)=n+nlog<sub>2</sub>n</button>
