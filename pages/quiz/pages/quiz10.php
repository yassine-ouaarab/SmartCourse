    ...
    margin-top: 10px;">
        <div class="sidebar-nav navbar-collapse" style="background-color : #f3f3f3">
            ...
            <li>
                        ...
                        <li>
                            <a href="quiz10.php" class="active">
...
<br><br><br>
   ...
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">Theta(n/2)</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">Theta(n<sup>2</sup>)</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">Theta(n<sup>3</sup>)</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;" >Theta(n)</button>
