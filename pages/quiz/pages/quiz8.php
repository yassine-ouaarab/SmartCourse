...
font-size: 14px;"><img src="img/admiine.png" style="width: 25px;
    ...
    <div id="page-wrapper" style="margin:0 0 0 320px">
           ...
           Trouver c et n<sub>0</sub> pour big O avec T(n)=c1.n<sup>2</sup>c2 ?
            </div>
   <br>
...
<br><br><br>
   ...
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">c=c1*c2 et n<sub>0</sub> = 10</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">c=c1+c2 et n<sub>0</sub> = 1</button><br><br><br>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">c=c1/c2 et n<sub>0</sub> = 2</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;" >c=c1-c2 et n<sub>0</sub> = 0</button>
