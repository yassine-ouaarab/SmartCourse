...
font-size: 14px;"><img src="img/admiine.png" style="width: 25px;
    ...
    <div id="page-wrapper" style="margin:0 0 0 320px">
            ...
            Calculer T(n) de l'algorithme suivant si en prise en compte tous les instructions constants ? </div>
    <br><br>
...
<br><br><br>
    ...
    border: none;
    padding: 9px 19px;
    border-radius: 20px;" name="two" id="quiz12">6n<sup>2</sup>+2n+1</button>
            <button style="    margin-left: 90px;
    border: none;
    padding: 9px 19px;
    border-radius: 20px;" name="tres" id="quiz13">6n<sup>2</sup>+10n+4
</button>
            <button style="    margin-left: 90px;
    border: none;
    padding: 9px 19px;
    border-radius: 20px;" name="four" id="quiz14">6n<sup>2</sup>+6n</button>
...
<?php 
    ...
    font-weight: 500;
                 ...
                 <div style="display:flex"><img src="../img/robot.png" style="width: 47px;"><p id="hahaho">Hint : la valeur de nombre de n est incorrect</P></diV><br>
                 <img src="../img/hint21.jpg">
...
if (isset($_POST['two'])) 
    ...
    margin-right: -48px;
    margin-top: 28px;">
                <a href="quiz1.php"><img style="margin-right: 7px;width:32px" src="../img/previous.png"></a>
                <a href="quiz3.php" ><img style="width:32px" src="../img/next.png"></a>
                <br><br><br>
            </div>
            </form>
