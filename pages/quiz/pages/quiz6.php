...
font-size: 14px;"><img src="img/admiine.png" style="width: 25px;
    ...
    <div id="page-wrapper" style="margin:0 0 0 320px">
           ...
           Choiser la bonne reponse, pour la notion Big O ?
            </div>
   <br>
...
<br><br><br>
   ...
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">T(n) >= c.f(n) pour tout n > n0.</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">T(n) = cf(n) pour tout n > n0.</button><br><br><br>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">T(n) = cf(n) pour tout n < n0.</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;" >T(n) <= c.f(n) pour tout n > n<sub>0</sub>.</button>
    ...
    margin-right: -48px;
    margin-top: 28px;">
                <a href="quiz5.php"><img style="margin-right: 7px;width:32px" src="../img/previous.png"></a>
                <a href="quiz7.php" ><img style="width:32px" src="../img/next.png"></a>
            </div>
            </form>
