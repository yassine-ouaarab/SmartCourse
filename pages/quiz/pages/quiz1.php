...
font-size: 14px;"><img src="img/admiine.png" style="width: 25px;
    ...
    padding-right: 100px;">
            ...
            Calculer T(n) de boucle suivant si en prise en compte tous les instructions constants ? </div>
    <br><br>
...
<div id="opcty"><button style="    margin-left: 90px;
    border: none;
    padding: 9px 19px;
    border-radius: 20px;" name="one" id="quiz11">2n+4</button>
            <button style="    margin-left: 90px;
    border: none;
    padding: 9px 19px;
    border-radius: 20px;" name="two" id="quiz12">3n+4</button>
            <button style="    margin-left: 90px;
    border: none;
    padding: 9px 19px;
    border-radius: 20px;" name="tres" id="quiz13">2n+6</button>
            <button style="    margin-left: 90px;
    border: none;
    padding: 9px 19px;
    border-radius: 20px;" name="four" id="quiz14">3n+6</button></div>
...
<?php 
    ...
    font-weight: 500;
                 ...
                 <br><br><br><br>
                 <div style="display:flex"><img src="../img/robot.png" style="width: 47px;"><p id="hahaho">Reponse Incorrect :(</p></diV><br>
                 <div style="display:flex"><img src="../img/robot.png" style="width: 47px;"><p id="hahaho">Hint N°1 : la valeur de nombre de n est incorrect</P></diV><br>
                 <img src="../img/hint11.jpg">
...
if (isset($_POST['two'])) 
    ...
    font-weight: 500;
                    ...
                    <br><br>
                    <br><br>
                 <div style="display:flex"><img src="../img/robot.png" style="width: 47px;"><p id="hahaho">Reponse Correct :)</p></diV><br>
    ...
    font-weight: 500;
                                        ...
                                        <br><br><br><br>
                 <div style="display:flex"><img src="../img/robot.png" style="width: 47px;"><p id="hahaho">Reponse Incorrect :(</p></diV><br>
                 <div style="display:flex"><img src="../img/robot.png" style="width: 47px;"><p id="hahaho">Hint N°2 : la valeur de nombre de n est incorrect</P></diV><br>
                 <img src="../img/hint13.jpg">
    ...
    font-weight: 500;
                                           ...
                                           <br><br><br><br>
                 <div style="display:flex"><img src="../img/robot.png" style="width: 47px;"><p id="hahaho">Reponse Incorrect :(</p></diV><br>
                 <div style="display:flex"><img src="../img/robot.png" style="width: 47px;"><p id="hahaho">Hint N°3 : la valeur de nombre de n est incorrect</P></diV><br>
                 <img src="../img/hint12.jpg">
                      <?php
                         }?>
    ...
    margin-right: -48px;
    margin-top: 28px;">
                <a href="quiz2.php" ><img style="width:32px" src="../img/next.png"></a>
                <br><br><br>    
            </div>
            </form>
