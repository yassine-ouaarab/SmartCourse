...
<br><br><br>
    ...
    padding: 9px 19px;
    border-radius: 20px;
    background: #d7d8cb;">log<sub>n</sub>3</button>
            <button style="    margin-left: 90px;
    border: none;
    padding: 9px 19px;
    border-radius: 20px;
    ...
    margin-right: -48px;
    margin-top: 28px;">
                <a href="quiz2.php"><img style="margin-right: 7px;width:32px" src="../img/previous.png"></a>
                <a href="quiz4.php" ><img style="width:32px" src="../img/next.png"></a>
            </div>
            </form>
