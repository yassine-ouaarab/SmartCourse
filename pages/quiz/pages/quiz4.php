...
<br><br><br>
   ...
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">2n+4</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">6n<sup>2</sup>+2n+1</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">6n<sup>2</sup>+5n+1</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;" >6n<sup>2</sup>+6n</button>
    ...
    margin-right: -48px;
    margin-top: 28px;">
                <a href="quiz3.php"><img style="margin-right: 7px;width:32px" src="../img/previous.png"></a>
                <a href="quiz5.php" ><img style="width:32px" src="../img/next.png"></a>
            </div>
            </form>
