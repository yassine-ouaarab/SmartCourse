...
<br><br><br>
   ...
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">T(n)= 2<sup>log<sub>3</sub>n</sup> = O(1)</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">T(n)= v9n = O(1)</button><br><br><br>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">T(n)= 10 = O(1)</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;" >T(n)= 10n<sup>2</sup>+n<sup>4</sup>+n = O(n<sup>2</sup>)</button>
