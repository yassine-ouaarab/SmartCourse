...
font-size: 14px;"><img src="img/admiine.png" style="width: 25px;
    ...
    <form method="POST" class="form-horizontal" enctype="multipart/form-data">
           ...
           Calculer T(n) de l'algorithme suivant en utilisant les sommmations ?
            </div>
   <br><br>
...
<br><br><br>
   ...
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">(n<sup>log<sub>2</sub>n</sup>+n)/2</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">(n<sup>2</sup>+n)/2</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">6n<sup>3</sup>+2n+1</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;" >log<sub>3</sub>n</button>
    ...
    margin-right: -48px;
    margin-top: 28px;">
                <a href="quiz4.php"><img style="margin-right: 7px;width:32px" src="../img/previous.png"></a>
                <a href="quiz6.php" ><img style="width:32px" src="../img/next.png"></a>
            </div>
            </form>
