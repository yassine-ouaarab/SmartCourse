    ...
    margin-top: 10px;">
        <div class="sidebar-nav navbar-collapse" style="background-color : #f3f3f3">
            ...
            <li>
                        ...
                        <li>
                            <a href="quiz11.php" class="active">
...
<br><br><br>
   ...
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">T(n)=10((1-n)/(1-2))
</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">T(n)=10(n/2)</button><br><br><br>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;">T(n)=2(n/2)+10</button>
           <button style="    margin-left: 90px;
   border: none;
   padding: 9px 19px;
   border-radius: 20px;
   background: #d7d8cb;" >T(n)=2(n/2)</button>
