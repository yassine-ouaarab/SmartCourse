...
<div class="container navigation" style="margin-top: -7px;">
...
<li class="dropdown" style="border-bottom:none">
        <a href="tuto.php" class="dropdown-toggle" data-toggle="dropdown" style="color: #f5f5f5;
FONT-FAMILY: cabin;
letter-spacing: 1px;
font-size: 13px;background: transparent;"><img src="../../DATABASE/admiine.png" style="width: 25px;
        height: 25px;
        margin-top: -5px;
        margin-right: 3px;"> TUTORIAL</a>

        <ul class="dropdown-menu" style="background-color: #292c2f;border:none">
            <li style="border-bottom: none"><a href="../tutorial/pages/text1.php" style="color: #f5f5f5;
FONT-FAMILY: cabin;
letter-spacing: 0.5px;
font-size: 12px;">Text</a>
            </li>

            <li style=""><a href="../tutorial/pages/video.php" style="color: #f5f5f5;
FONT-FAMILY: cabin;
letter-spacing: 0.5px;
font-size: 12px;">Video</a></li>
        </ul>
        </li>
...
FONT-FAMILY: cabin;
letter-spacing: 1px;
font-size: 14px;"><img src="../../DATABASE/admiine.png" style="width: 25px;
        height: 25px;
        margin-top: -5px;
...
font-size: 14px;"><img src="../../DATABASE/admiine.png" style="width: 25px;
        height: 25px;
        margin-top: -5px;
        margin-right: 3px;"> COMPILER</a></li>
...
<li class="dropdown">
    <a href="#" id="carettt" class="dropdown-toggle" data-toggle="dropdown" style="color: #f5f5f5;background: transparent;">
        <img src="img/admiine.png" style="width: 25px;
        height: 25px;
        margin-top: -5px;
        margin-right: 3px;">Profile</a>
...
<?php
    $idParticip=$_SESSION['id_particip'];?>
        ...
        <li style="border-bottom: none"><a href="../profile/pages/profile.php" style="color: #f5f5f5;
FONT-FAMILY: cabin;
letter-spacing: 0.5px;
...
FONT-FAMILY: cabin;
letter-spacing: 0.5px;
font-size: 12px;">Statistique</a></li>
...
<!-- /.container -->
 ...
 <div style="margin-top: -80px;
    width: 1423px;
    height: 799px;
    background-image: url(img/rbi4.jpg);
    ...
    margin-left: 243px;
">
        <div class=" home-content" style="padding-right: 2px;
    padding-left: 0px;
    padding-top: 52px;
    background: #ffffff1f;
    padding-bottom: 43px;">
    ...
    font-size: 45px;
    font-weight: 700;
    font-family: cabin;">Moderne outils pour vrais apprentissage</h1>
          ...
          <div class="col-sm-3 col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <h4 class="h-bold">Benifier meuilleur course bient expliquet</h4>
          ...
          <div class="col-sm-3 col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <h4 class="h-bold">Apprentissage à l'aide de la Technologie STI</h4>
          ...
          <div class="col-sm-3 col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <h4 class="h-bold">Consulter le progress d'aprentissage</h4>
    ...
    <footer>
        <div class="container" style="padding-bottom: 0px;">
            <div class="row">
              ...
              <h6 style="font-size: 13px;color: #dddddd;margin-top: 18px;">&copy; Copyright SmartCourse 2020.</h6>
             </div>
                </div>
                <div class="col-sm-3 col-lg-3">
